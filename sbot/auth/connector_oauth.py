...
Mirrors the login flow in ``sbot.auth.oidc`` but for connectors:
...
from sbot.auth.tokens import TokenError, decode_access_token, encode
from sbot.config import Settings
from sbot.core.connector_presets import ConnectorPreset
