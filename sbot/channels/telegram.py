...
from sbot.channels.base import Channel
from sbot.channels.link import LinkCodeService
from sbot.core.runtime import AgentRuntime, TurnFailed
from sbot.db.stores import SessionStore, UserStore

_API = "https://api.telegram.org"

_LINK_PROMPT = (
    "👋 Your Telegram isn't linked to a Softnix Sbot account yet.\n"
...
class TelegramChannel(Channel):
    ...
    async def _handle_link_command(self, text: str, tg_id: str) -> str:
        ...
        return "✅ Your Telegram is now linked. You can chat with Sbot here."
