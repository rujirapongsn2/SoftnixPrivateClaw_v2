...
from sbot.core.development_skill import DEVELOPMENT_SKILL
...
- Every downstream calculation references those cells (`=B5*(1+$B$2)`), never
  repeats the number.
- **Source annotations**: add a cell comment (`ws["B2"].comment = Comment("Source: ...", "Sbot")`)
...
def insert_tracked_insertion(paragraph, text, author="Sbot"):
...
def mark_tracked_deletion(run, author="Sbot"):
...
_BUILTIN_SKILLS: tuple[BuiltinSkill, ...] = (
    BuiltinSkill(
        ...
        description="Build software with a team, persistent Docker projects, Compose services, GitHub and CI.",
        content=DEVELOPMENT_SKILL,
    ),
    BuiltinSkill(
        name="skill-creator",
        description=(
