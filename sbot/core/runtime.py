                ...
                if self.llm_config is not None:
                    ...
                    if effective_model is None and plan_chat_cost is not None:
                        ...
                        if any_global is not None:
                            ...
                            self.bus.publish(session_id, TurnError(turn_id=turn_id, message=msg))
                            return msg
                    # A My Models turn stays on credentials owned by the caller.
                    # Falling onto the global backstop here would bypass the
                    # Plan accounting that protects operator-funded models.
                    fallback_resolver = (
