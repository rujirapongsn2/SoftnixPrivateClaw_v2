...
_SUBAGENT_SYSTEM = (
    "You are a Sbot subagent: a focused worker running one delegated task to completion. "
...
class SubagentManager:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        tools.register(ProjectTool(self.sandbox, self.workspace, self.owner_id, self.project_access))
    ...
    async def run_result(
        ...
        try:
            ...
            if not outcome.final_content or outcome.timed_out or outcome.reached_max_iterations:
