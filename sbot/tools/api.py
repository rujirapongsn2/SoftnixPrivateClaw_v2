...
from sbot.security.ssrf import UnsafeUrlError, resolve_public_ips
...
# (not imported directly to avoid a sbot.tools <-> sbot.core import cycle at
...
class GenericApiTool(Tool):
    ...
    async def execute(self, **kwargs: Any) -> str:
        # Deferred to avoid a sbot.tools <-> sbot.core import cycle — see the
